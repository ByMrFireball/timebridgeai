        ...
        <div className='menucostado'>
          <div className="arribaCostado">
            ...
            <div className="arribaCostadoDebajo">
              <button className="query"><img src={MsgIcon} alt="Query" className="" />Que es la programacion?</button>
              <button className="query"><img src={MsgIcon} alt="Query" className="" />Como usar una Api?</button>
            </div>
